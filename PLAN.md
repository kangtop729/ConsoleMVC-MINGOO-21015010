...
> 이 저장소는 Main 프로젝트(`SampleOrderSystem-MINGOO-21015010`)의 참고용 PoC다.
> Main이 이 코드를 그대로 가져다 쓰지는 않지만, "MVC로 역할이 분리된 구조"라는 개념은 Main에서도 동일하게 유지한다.

## 2. 저장소 정보

- Repository: `ConsoleMVC-MINGOO-21015010` (Public)
